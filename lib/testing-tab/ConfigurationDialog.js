    ...
    <div className="crpa-Runner-Selection">
      <Section level={ 3 }>
        <Stack gap={ 5 }>
          ...
          <Section>
            Need more guidance? Check out our <Link href="https://docs.camunda.io/docs/next/components/RPA/getting-started/" target="_blank">getting started guides</Link> for step-by-step instructions.
          </Section>

          <div className="button-container">
            <Link href="https://github.com/camunda/rpa-worker/releases" renderIcon={ () => <ArrowRight aria-label="Arrow Right" /> } target="_blank">
              Download RPA worker
            </Link>
          </div>
        </Stack>
